...
let s:_magenta = '#EA93D3'
let s:_blue = ''

let g:airline#themes#bubblegum#palette = {}

" Normal mode
let s:N1 = [s:gui_dark_gray, s:gui_pink, s:cterm_dark_gray, s:cterm_purple]
" let s:N1 = [s:gui_dark_gray, s:gui_pink, s:cterm_dark_gray, s:cterm_pink]
" let s:N1 = [s:gui_dark_gray, s:_magenta, s:cterm_dark_gray, s:_magenta]
let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_pink, s:cterm_med_gray_lo]
let s:N3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi]
